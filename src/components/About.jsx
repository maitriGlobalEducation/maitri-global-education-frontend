...
export default function About() {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center w-full min-h-[60vh] bg-[#2d2d2d] px-4 py-10 gap-8">
      {/* Left: Image */}
      ...
      <div className="w-full md:w-1/2 flex flex-col items-start justify-center gap-6 max-w-lg" data-aos="fade-left">
        <h2 style={{ fontFamily: 'Epika', fontWeight: 'bold' }} className="text-white font-bold text-2xl md:text-3xl leading-tight uppercase tracking-tight">
